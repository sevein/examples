...
Example:
    %[1]s chatter echoer --token "Cum et deserunt quo molestiae officia ex."
`, os.Args[0])
}
...
Example:
    %[1]s chatter listener --token "Ut esse quaerat."
`, os.Args[0])
}
...
Example:
    %[1]s chatter summary --token "Quibusdam aliquid in sequi mollitia debitis."
`, os.Args[0])
}
...
Example:
    %[1]s chatter subscribe --token "Eveniet repellendus eum aut ut."
`, os.Args[0])
}
...
Example:
    %[1]s chatter history --view "Rerum quos veritatis veritatis soluta qui." --token "Et eius velit repellendus quis sunt quis."
`, os.Args[0])
}
